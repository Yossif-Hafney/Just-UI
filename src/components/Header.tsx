...
export default function Header() {
  ...
  return (
    <header className="bg-white h-12 sm:h-14 shadow fixed top-0 left-0 w-full z-30">
      <div className="container px-2 sm:px-4 py-2 flex items-center justify-between h-12 sm:h-14">
        {/* Left: Logo + Search */}
        <div className="flex items-center gap-2 sm:gap-4 w-full sm:w-[320px] relative">
          <FaFacebook className="text-[#1877f2] text-[30px] sm:text-[41px]" />
          {/* Search on small/medium: only icon */}
          <div className="sm:block md:block lg:hidden cursor-pointer relative">
            <div
              onMouseEnter={() => setHoveredButton("search")}
              onMouseLeave={() => setHoveredButton(null)}
            >
              <IoIosSearch className="text-gray-500 text-[20px] sm:text-[24px]" />
            </div>
          ...
          <div className="hidden lg:block relative w-[240px] ">
            <input
              type="text"
        ...
        {/* Center: Icons */}
        <div className="hidden md:flex items-center gap-2 justify-center w-[446px]">
          <div>
            <FloatingDock
              items={[
                {
